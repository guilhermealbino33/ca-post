  ...
  handle = async (req: Request, res: Response) => {
    ...
    */
    ...
    try {
      ...
      const batch = parents?.map(({ ID: channelId, Sku }, index: number) => {
      ...
      console.log("batchChild", batch);
      // batchBody.push(batch);
      ...
      // console.log(
      //   "createChild",
      //   createChild.data.responses.map((item: any) => item.body.value[0])
      // );
      /**
         * @todo
